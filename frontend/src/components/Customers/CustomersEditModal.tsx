...
const CustomersEditModal: React.FC<CustomersEditModalProps> = ({
  isOpen,
  onClose,
  customer,
  onCustomerUpdated
  ...
  useEffect(() => {
    if (isOpen && customer) {
      // Determine if addresses are actually the same
      const addressesAreSame = isShippingSameAsBilling(customer);
      setSameAsBilling(addressesAreSame);
  ...
  const updateCustomerMutation = useMutation({
    ...
    onError: (error: unknown) => {
      ...
      const errorDetails = (error as { response?: { data?: { details?: Record<string, string> } } }).response?.data?.details || {};
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2.5 border-2 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-700/50 dark:border-gray-600 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                        sameAsBilling ? 'bg-gray-100 dark:bg-gray-600 cursor-not-allowed' : 'hover:border-gray-300 dark:hover:border-gray-500'
                      } ${
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    disabled={sameAsBilling}
                    className={`w-full px-3 py-2.5 border-2 border-gray-200 dark:border-gray-600 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-700/50 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                      sameAsBilling ? 'bg-gray-100 dark:bg-gray-600 cursor-not-allowed' : 'hover:border-gray-300 dark:hover:border-gray-500'
                    }`}
                    placeholder="Enter company name"
                  />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled={sameAsBilling}
                        className={`w-full pl-10 pr-3 py-2.5 border-2 border-gray-200 dark:border-gray-600 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-700/50 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                          sameAsBilling ? 'bg-gray-100 dark:bg-gray-600 cursor-not-allowed' : 'hover:border-gray-300 dark:hover:border-gray-500'
                        }`}
                        placeholder="Enter street address"
                      />
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    disabled={sameAsBilling}
                    className={`w-full px-3 py-2.5 border-2 border-gray-200 dark:border-gray-600 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-700/50 dark:text-white ${
                      sameAsBilling ? 'bg-gray-100 dark:bg-gray-600 cursor-not-allowed' : 'hover:border-gray-300 dark:hover:border-gray-500'
                    }`}
                  >
                    <option value="BD">Bangladesh</option>
