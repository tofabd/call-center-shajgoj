...
const IncomingCalls: React.FC<IncomingCallsProps> = ({
  callLogs,
  selectedCallId,
  loading,
  error,
  ...
  React.useEffect(() => {
    ...
    console.log('📊 IncomingCalls: Call logs updated, count:', callLogs.length);
  }, [callLogs]);

  React.useEffect(() => {
    // Log when selectedCallId changes to track auto-selection
    if (selectedCallId) {
      console.log('🎯 IncomingCalls: Selected call ID changed to:', selectedCallId);
    }
  }, [selectedCallId]);
        ...
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 flex-shrink-0">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Incoming Calls</h3>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 truncate font-mono mb-2">
                            {call.callerNumber}
                          </p>
